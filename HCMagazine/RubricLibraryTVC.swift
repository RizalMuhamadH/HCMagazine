//
//  RubricLibraryTVC.swift
//  HCMagazine
//
//  UITableView that display article of one rubric (Per Rubric Scene) from library
//
...
class RubricLibraryTVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
